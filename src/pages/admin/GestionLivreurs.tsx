      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all shadow-sm shrink-0 w-full sm:w-auto"
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center shrink-0">
                  <Icon icon="mdi:format-list-bulleted" className="text-lg text-gray-600" />
                </div>
                <div className="min-w-0 flex-1">
                  <h2 className="text-base sm:text-lg font-semibold text-gray-900 truncate">Équipe de livraison</h2>
                  <p className="text-xs sm:text-sm text-gray-500 truncate">{livreurs.length} livreur(s) enregistré(s)</p>
                </div>
              </div>

              <div className="flex items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600 shrink-0">
            ...
            {livreurs.length === 0 ? (
              <div className="text-center py-12 sm:py-16">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                  <Icon icon="mdi:truck-delivery-outline" className="text-3xl sm:text-4xl text-gray-400" />
                </div>
                ...
                <button
                  onClick={handleNouveauLivreur}
                  className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all shadow-sm"
                >
                  <Icon icon="mdi:plus" className="text-lg" />
              ...
              <div className="grid gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-3">
                {livreurs.map((livreur) => (
                  <div
                    key={livreur.id}
                    className="bg-white border border-gray-200 rounded-xl p-4 sm:p-5 hover:border-gray-300 hover:shadow-md transition-all duration-200 overflow-hidden"
                  >
                    {/* Header du livreur */}
                    <div className="flex items-start justify-between mb-3 sm:mb-4">
                      <div className="flex items-start gap-2 sm:gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-semibold text-base sm:text-lg text-gray-900 mb-1 truncate" title={livreur.nom}>
                            {livreur.nom}
                          </h3>
                    ...
                    <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5">
                      {livreur.telephone && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs sm:text-sm text-gray-700 truncate">{livreur.telephone}</span>
                        </div>
                      )}
                      ...
                      {livreur.vehicule && (
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-2 sm:p-3">
                          <div className="flex items-center gap-2">
                            <Icon icon="mdi:car" className="text-gray-600 shrink-0" />
                            <div className="min-w-0 flex-1">
                              <div className="text-[10px] sm:text-xs font-medium text-gray-500 mb-0.5">Véhicule</div>
                              <div className="text-xs sm:text-sm font-semibold text-gray-900 truncate" title={livreur.vehicule}>{livreur.vehicule}</div>
                            </div>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-gray-700 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 rounded-lg transition-all text-xs sm:text-sm font-medium"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1.5 px-3 py-2 text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 rounded-lg transition-all text-xs sm:text-sm font-medium"
                      >
