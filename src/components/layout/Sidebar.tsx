...
const SECTIONS: { label: string; ids: string[] }[] = [
  ...
  { label: 'Gestion', ids: ['stocks', 'depenses', 'comptabilite', 'creances', 'rapport'] },
...
export const Sidebar: React.FC<SidebarProps> = ({ mobileOpen, collapsed, onClose }) => {
  ...
  const filteredNavigation = APP_MODULES.filter(module => {
    ...
    const rolePermissions: Record<string, string[]> = {
      gestionnaire: ['dashboard', 'pos', 'pos_historique', 'production', 'rotation', 'facturation', 'stocks', 'depenses', 'comptabilite', 'creances', 'rapport', 'fiche_produit'],
      boulanger: ['boulanger'],
